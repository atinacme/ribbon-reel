...
import {
  Card, Page, Layout, TextContainer, Link, Heading, Button, Thumbnail, Stack, ButtonGroup, Banner, Modal
} from "@shopify/polaris";
import { useNavigate } from "@shopify/app-bridge-react";
import { Mark, Vector1, Brand1, Step1, Step2, Step3, Arrowright, Logotype } from "../assets";
              ...
              <TextContainer>
                <div className="modal-wrapper">
                  <div className="brand_img">
                    <img src={Brand1} alt="" />
                    <h2 className="e1sb txt28 mb20 mt20">How Ribbon Reel Work?</h2>
                  </div>
                  <div className="modal-content">
                    <div className="modal-content_wrap mt30">
                      <div className="modal_img"><img src={Step1} alt="" /></div>
                      <div className="modal_title e1r txt22 mt20 mb20">Fill the details in the landing page and after completing these steps you can see all the orders with products containing RIBBON_REELS_CARD as vendor</div>
                    </div>
                    <div className="modal-content_wrap mt30">
                      <div className="modal_img"><img src={Step2} alt="" /></div>
                      <div className="modal_title e1r txt22 mt20 mb20">You can change the above data in settings</div>
                    </div>
                    <div className="modal-content_wrap mt30">
                      <div className="modal_img"><img src={Step3} alt="" /></div>
                      <div className="modal_title e1r txt22 mt20 mb20 ">You can get Help from Support</div>
                    </div>
                  </div>
                </div>
              </TextContainer>
